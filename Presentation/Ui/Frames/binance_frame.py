...
class BinanceFrame:
    def __init__(self, app_instance):
        ...
        self.app_instance.binance_frame_large_image_label = customtkinter.CTkLabel(
            self.app_instance.binance_frame, text="", image=self.app_instance.large_test_image)
        self.app_instance.binance_frame_large_image_label.grid(row=0, column=0, padx=20, pady=10)

        self.app_instance.binance_frame_button_1 = customtkinter.CTkButton(
            self.app_instance.binance_frame, text="",
            image=self.app_instance.image_icon_image)
        self.app_instance.binance_frame_button_1.grid(row=1, column=0, padx=20, pady=10)

        self.app_instance.binance_frame_button_2 = customtkinter.CTkButton(
            self.app_instance.binance_frame, text="CTkButton",
            image=self.app_instance.image_icon_image,
            compound="right")
        ...
        self.app_instance.binance_frame_button_4 = customtkinter.CTkButton(
            self.app_instance.binance_frame,
            text="CTkButton",
            image=self.app_instance.image_icon_image,
            compound="bottom",
