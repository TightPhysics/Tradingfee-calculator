...
class NavigationFrame:
    def __init__(self, app_instance):
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(master=self.navigation_frame,
                                                             text=const.logoText,
        ...
        self.app_instance.home_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0,
                                                                height=40,
                                                                border_spacing=10,
        ...
        self.app_instance.home_button.grid(row=1, column=0, sticky="ew")

        self.app_instance.frame_2_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0,
                                                                   height=40,
        ...
        self.app_instance.frame_2_button.grid(row=2, column=0, sticky="ew")

        self.app_instance.frame_3_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0,
                                                                   height=40,
        ...
        self.app_instance.frame_3_button.grid(row=3, column=0, sticky="ew")
